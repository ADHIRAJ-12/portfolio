...
const achTitleLarge=document.querySelector(".achTitleLarge")
const achTitle=document.querySelector(".achTitle")
...
window.addEventListener("scroll",()=>{
    ...
    achTitleLarge.style.transform=`translateX(calc(950vh - ${offsetY  }px))`
    achTitle.style.transform=`translateX(calc(950vh - ${offsetY  }px))`
